...
<template>
    <div v-if="mode.edit" :class="config.theme" id="overlay-menu">
        <div class="menu-bar">
            <button class="close-btn-menu" @click="mode.toggleEdit()">
            ...
            <div class="menu-body">
                ...
                <form @submit.prevent >
                    ...
                    <button id="export-config" @click="saveLink()">
                        Ajouter
                    </button>
                </form>
            ...
            <footer>
                <svg width="3187" height="550" viewBox="0 0 3187 550" fill="none" xmlns="http://www.w3.org/2000/svg">
