...
<template>
    <nav :class="save.theme">
        ...
        <ul>
            ...
            <!-- <li>
                <button @click="mode.toggleMenuWidget()">
            ...
            <li id="menu" @click="mode.toggleMenu()">
                <button>
